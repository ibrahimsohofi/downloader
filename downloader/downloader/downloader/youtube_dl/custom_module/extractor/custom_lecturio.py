...
class CustomLecturioBaseIE(InfoExtractor):
...
class CustomLecturioIE(CustomLecturioBaseIE):
    _VALID_URL = r'''(?x)
                    https://
                        (?:
...
class CustomLecturioCourseIE(CustomLecturioBaseIE):
    ...
    def _real_extract(self, url):
        ...
        for lecture in course.get('lectures', []):
            ...
            entries.append(self.url_result(
                lecture_url, ie=CustomLecturioIE.ie_key(), video_id=lecture_id))
        return self.playlist_result(
            entries, display_id, course.get('title'),
            clean_html(course.get('description')))


class CustomLecturioDeCourseIE(CustomLecturioBaseIE):
