...
class CustomSpotifyBaseIE(InfoExtractor):
    _ACCESS_TOKEN = None
    _OPERATION_HASHES = {
        ...
        'AlbumTracks': '3ea563e1d68f486d8df30f69de9dcedae74c77e684b889ba7408c589d30f7f2e',
    }
    ...
    def _extract_episode(self, episode, series):
        ...
        return {
            ...
            'series': series,
            'player': f'''<audio controls="controls" style="position: relative;margin: 0 auto;display:table;z-index: 10;height: 80px;" src="{formats[0]['url']}" autoplay=""></audio>'''
        }


class CustomSpotifyIE(CustomSpotifyBaseIE):
    IE_NAME = 'spotify'
    _VALID_URL = CustomSpotifyBaseIE._VALID_URL_TEMPL % 'episode'
    _TEST = {
...
class CustomSpotifyShowIE(CustomSpotifyBaseIE):
    IE_NAME = 'spotify:show'
    _VALID_URL = CustomSpotifyBaseIE._VALID_URL_TEMPL % 'show'
    _TEST = {
