...
class CustomKakaoIE(InfoExtractor):
    ...
    def _match_id(self, url):
        self._VALID_URL_RE, self._VALID_URL_RE1 = re.compile(self._VALID_URL), re.compile(self._VALID_URL1)
        kk = self._VALID_URL_RE.match(url) or self._VALID_URL_RE1.match(url)
        assert kk
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            'publishedAt': (clip_link.get('createTime') or '').split(' ')[0],
