...
class CustomClypIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        json_rs = self._download_json(
            'https://api.clyp.it/%s/playlist' % audio_id, audio_id)

        metadata = json_rs['AudioFiles'][0]
        formats = []
        ...
        thumbnail = metadata['ArtworkPictureUrl']
