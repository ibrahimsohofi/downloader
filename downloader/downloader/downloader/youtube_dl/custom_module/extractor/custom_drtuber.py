...
class CustomDrTuberIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        for format_id, video_url in video_data['files'].items():
            if video_url:
                formats.append({
                    ...
                    'height': 720 if format_id == 'hq' else 320,
                    'url': video_url
                })
        ...
        return {
            ...
            'player': '<iframe width="100%" height="100%" frameborder="0" allowfullscreen src="https://www.drtuber.com/embed/{}"></iframe>'.format(video_id),
